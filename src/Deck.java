...
public class Deck {
	...
	public void initialisation(){
		...
		int [] cotes2 = {2, 0, 1, 0, 1, 0, 0, 0, 1};
		t = new Tuile(2, cotes2);
		for(int i=0; i<3; i++)
			deck.add(t);
		
		int [] cotes3 = {2, 0, 1 , 0, 1, 0, 2, 2, 0};
		t = new Tuile(3, cotes3, true);
		for(int i=0; i<2; i++) 
			deck.add(t);
		
		int [] cotes4 = {2, 2, 2, 0, 1 , 0, 2, 2, 2};
		t = new Tuile(4, cotes4);
		deck.add(t);
		
		int [] cotes5 = {2, 2, 2, 0, 0 , 0, 2, 2, 2};
		t = new Tuile(5, cotes5, true);
		deck.add(t);
		
		int [] cotes6 = {2, 0, 1 , 0, 1, 0, 2, 2, 0};
		t = new Tuile(6, cotes6);
		for(int i=0; i<3; i++)
			deck.add(t);
		
		int [] cotes7 = {2, 0, 1, 0, 1, 0, 1, 0, 1};
		t = new Tuile(7, cotes7);
		for(int i=0; i<3; i++)
			deck.add(t);
		
		int [] cotes8 = {1, 0, 0 , 0, 1 , 0, 0, 1};
		t = new Tuile(8, cotes8);
		for(int i=0; i<8; i++)
			deck.add(t);
		
		int [] cotes9 = {0, 0, 1, 0, 1, 0, 1, 0, 1};
		...
		int [] cotes11 = {2 ,2 , 2, 0, 0, 0, 0, 0, 0};
		t = new Tuile(11, cotes11);
		for(int i=0; i<2; i++)
			deck.add(t);
		
		int [] cotes12 = {2, 2, 2, 0, 0 , 0, 2, 2, 2};
		t = new Tuile(12, cotes12);
		for(int i=0; i<3; i++)
			deck.add(t);
		
		int [] cotes13 = {0 ,0 ,0 ,0, 0, 0, 0, 0, 3};
		t = new Tuile(13, cotes13);
		for(int i=0; i<4; i++)
			deck.add(t);
		
		int [] cotes14 = {0 ,0 ,0 ,0, 1, 0, 0, 0, 3};
		t = new Tuile(14, cotes14);
		for(int i=0; i<2; i++)
			deck.add(t);
		
		int [] cotes15 = {2, 0, 0, 0, 0, 0, 2, 2, 0};
		t = new Tuile(15, cotes15);
		for(int i=0; i<3; i++)
			deck.add(t);
		
		int [] cotes16 = {0 , 0, 2, 0, 0, 0, 2, 0, 2};
		...
		int [] cotes18 = {2, 0, 0, 0, 1, 0, 1, 0, 1};
		t = new Tuile(18, cotes18);
		for(int i=0; i<3; i++)
			deck.add(t);
		
		int [] cotes19 = {0 , 0, 2, 0, 0, 0, 2, 0, 2};
		t = new Tuile(19, cotes19);
		deck.add(t);
			
		int [] cotes20 = {2, 2, 2, 0, 1 , 0, 2, 2, 2};
		t = new Tuile(20, cotes20, true);
		for(int i=0; i<2; i++)
			deck.add(t);
	
		int [] cotes21 = {2, 2, 2, 2, 2, 2, 2, 2, 2};
		...
		int [] cotes23 = {2, 0, 0 , 0, 0, 0, 2, 2, 0};
		t = new Tuile(23, cotes23, true);
		for(int i=0; i<2; i++)
			deck.add(t);
		
		int [] cotes24 = {0, 0, 2 , 0, 0, 0, 2, 0, 0};
